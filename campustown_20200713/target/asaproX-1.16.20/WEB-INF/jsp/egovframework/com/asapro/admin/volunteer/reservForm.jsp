...
jQuery(function($){
	...
	$('#printBtn').on('click', function(e){
		...
		window.open( '${ADMIN_PATH}/volunteer/reservation/printPreview.do?reservId=${volunteerReservationForm.reservId }' , 'printForm' , 'width=800,height=1000,menubar=no,status=no,toolbar=no' );
	});
					        ...
					        <div class="card m-b-15">
					            <div class="card-body">
									...
									<div class="p-3 mb-3 bg-light text-info font-weight-bold">
										<div><i class="mdi mdi-information"></i> 자원봉사 신청 </div>
									</div>
									
					            	<c:if test="${formMode eq 'INSERT'}"><c:set var="actionUrl" value="${ADMIN_PATH}/volunteer/reservation/insert.do" /></c:if>
									<c:if test="${formMode eq 'UPDATE'}"><c:set var="actionUrl" value="${ADMIN_PATH}/volunteer/reservation/update.do" /></c:if>
						            <form:form modelAttribute="volunteerReservationForm" cssClass="" action="${actionUrl}" method="post" enctype="multipart/form-data">
										...
										<div class="form-group row">
											<form:label path="reservGroup" cssClass="col-sm-2 col-form-label">신청자 그룹 <span class="text-danger">*</span></form:label>
											<div class="col-sm">
										...
										<div class="form-group row">
											<form:label path="reservPeople" cssClass="col-sm-2 col-form-label">인원 </form:label>
											<div class="col-sm form-inline">
										...
										<div class="form-group row">
											<form:label path="reservPurpose" cssClass="col-sm-2 col-form-label">목적 <span class="text-danger">*</span></form:label>
											<div class="col-sm">
												<form:textarea path="reservPurpose" cssClass="form-control col-sm-8" rows="3"  />
												<form:errors path="reservPurpose" element="div" cssClass="text-danger" />
											</div>
										</div>
										
										<div class="form-group row">
											<form:label path="reservDate" cssClass="col-sm-2 col-form-label">봉사희망날짜 <span class="text-danger">*</span></form:label>
											<div class="col-sm form-inline">
												...
												<span class="form-text text-muted text-info mx-2"> - 자원봉사는 신청일로부터 2주일 전까지 예약</span> 
												<form:errors path="reservDate" element="div" cssClass="text-danger col-form-label ml-2" />
											</div>
										</div>
										<div class="form-group row">
											<form:label path="reservStime" cssClass="col-sm-2 col-form-label">봉사희망시간 <span class="text-danger">*</span></form:label>
											<div class="col-sm form-inline">
										...
										<div class="form-group row">
											<form:label path="reservSuggest" cssClass="col-sm-2 col-form-label">기타건의사항 <span class="text-danger">*</span></form:label>
											<div class="col-sm">
												<form:textarea path="reservSuggest" cssClass="form-control col-sm-8" rows="3"  />
												<form:errors path="reservSuggest" element="div" cssClass="text-danger" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<a href="${ADMIN_PATH}/volunteer/reservation/list.do" class="btn btn-secondary waves-effect m-l-5">목록</a>
											<c:if test="${volunteerReservationForm.reservStatus eq 'admission' }">
												<a href="${ADMIN_PATH}/volunteer/reservation/printPreview.do?reservId=${volunteerReservationForm.reservId }" id="printBtn" target="_blank" class="btn btn-info waves-effect m-l-5">신청서 미리보기</a>
											</c:if>
										</div>
									</form:form>
					            </div>
