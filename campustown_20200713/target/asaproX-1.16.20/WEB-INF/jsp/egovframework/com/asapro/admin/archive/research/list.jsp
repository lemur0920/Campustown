					...
					<div class="row">
					    <div class="col-sm-12">
					        <div class="card m-b-15">
					            <div class="card-body">
						            <form:form modelAttribute="researchSearch" cssClass="" action="${ADMIN_PATH}/archive/research/list.do" method="get">
							...
							<div class="card m-b-30">
								<div class="card-body">
											...
											<tbody>
												...
												<c:forEach items="${paging.result}" var="item" varStatus="vs">
													<tr>
														...
														<td>${item.resYear }</td>
														<td><a href="${ADMIN_PATH}/archive/research/update.do?arcId=${item.arcId}" class=""><strong>${item.arcTitle}</strong></a></td>
														<td>
									...
									<div class="form-inline">
										<div class="mr-auto">
											<a href="${ADMIN_PATH}/archive/research/insert.do?arcCategory=${archiveCategory.catId}" class="btn btn-primary waves-effect waves-light">추가</a>
