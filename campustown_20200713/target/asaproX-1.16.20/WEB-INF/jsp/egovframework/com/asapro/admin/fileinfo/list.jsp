					    ...
					    <div class="col-sm-12">
					        <div class="card m-b-15">
					            <div class="card-body">
						            ...
						            <form:form modelAttribute="fileInfoSearch" cssClass="form-inline" action="${ADMIN_PATH}/fileinfo/list.do" method="get">
												...
												<tr>
													<th class="text-center">
														<div class="custom-control custom-checkbox">
															<input type="checkbox" class="custom-control-input" id="selectAll" onclick="jQuery('[name=fileIds]').each(function(idx,el){this.checked=jQuery('#selectAll')[0].checked;});"/>
