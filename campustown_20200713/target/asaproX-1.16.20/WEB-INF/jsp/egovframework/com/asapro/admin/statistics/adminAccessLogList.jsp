					    ...
					    <div class="col-sm-12">
					        <div class="card m-b-15">
					            <div class="card-body">
						            ...
						            <form:form modelAttribute="statisticsAdminAccessLogSearch" cssClass="" action="${ADMIN_PATH}/statistics/admin/accessLog/list.do" method="get">
										...
										<div class="form-row mr-auto mt-2 form-inline">
											...
											<form:select path="sortOrder" cssClass="form-control mr-sm-2 mb-2" title="정렬기준">
												<form:option value="LOG_REGDATE" label="접속일시" />
												<form:option value="LOG_REMOTE_IP" label="접속아이피" />
												<form:option value="ADMIN_ID" label="관리자 아이디" />
												<form:option value="ADMIN_NAME" label="관리자 이름" />
											</form:select>
										...
										<div class="form-row mt-2 form-inline" >
											<label for="sc" class="mr-sm-3 mb-2">접속일</label>
											<form:input path="logStartDate" cssClass="form-control mr-sm-2 mb-2 datepicker-ui" cssErrorClass="form-control mr-sm-2 mb-2 datepicker-ui is-invalid" autocomplete="off"/>
											<span class="mx-2"> ~ </span>
											<form:input path="logEndDate" cssClass="form-control mr-sm-2 mb-2 datepicker-ui" cssErrorClass="form-control mr-sm-2 mb-2 datepicker-ui is-invalid" autocomplete="off"/>
										</div>
										<div class="form-row mt-2 form-inline" >
											...
											<tbody>
												...
												<c:forEach items="${paging.result}" var="item" varStatus="vs">
													<tr>
														...
														<td>${item.logRemoteIp}</td>
														<td>
															<fmt:formatDate value="${item.logRegDate}" pattern="yyyy-MM-dd HH:mm:ss" />
														</td>
														<td>${item.siteId}</td>
