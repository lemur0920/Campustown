...
<c:import url="${design.themeDir}/layout/sidebar2.jsp" charEncoding="UTF-8" />
	...
	<div class="founding-team-content">
		...
		<br/>
		<div class="table-con list-search">
			<form:form modelAttribute="boardArticleSearch" action="${APP_PATH}/startup/startup_news" method="get">
				<form:hidden path="baCommSelec"/>
				<form:hidden path="teamId" />
					<table>
						<caption>리스트검색</caption>
					<colgroup>
						...
						<c:forEach items="${noticeList}" var="item" varStatus="vs">
							<tr>
								...
								<td class="tb-txl">
									...
									<a class="art" href="${APP_PATH}/startup/startup_news/${item.baId}?compId=${item.teamId}">${item.baTitle}
