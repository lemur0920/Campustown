...
<c:import url="${design.themeDir}/layout/sidebar.jsp" charEncoding="UTF-8" />
		...
		<div class="galv_box clearfix">
			...
			<h4 class="tct tit_blue3 mb_30">${advertisingForm.arcTitle }</h4>
			...
			<div class="table tb_1">
				...
				<table>
					...
					<tbody>
						<tr>
							<th>연구주제</th>
							<td colspan="3" class="tlt"><strong>${asapro:codeName(advertisingForm.arcMetaCode1, arcMetaCode1List)}</strong></td>
						</tr>
						<tr>
