					        ...
					        <div class="card m-b-15">
					            <div class="card-body">
						            ...
						            <form:form modelAttribute="advertisingForm" cssClass="" action="${actionUrl}" method="post" enctype="multipart/form-data">
										...
										<div class="form-group row">
											<form:label path="adtAwardType" cssClass="col-sm-2 col-form-label">수상 </form:label>
											<div class="col-sm">
												<form:input path="adtAwardType" cssClass="form-control col-sm-3" cssErrorClass="form-control col-sm-3 is-invalid"  />
												<form:errors path="adtAwardType" element="div" cssClass="text-danger col-form-label ml-2" />
											</div>
										</div>
										<div class="form-group row">
											<form:label path="adtWinner" cssClass="col-sm-2 col-form-label">수상자 </form:label>
											<div class="col-sm">
												<form:input path="adtWinner" cssClass="form-control col-sm-6" cssErrorClass="form-control col-sm-6 is-invalid"  />
												<form:errors path="adtWinner" element="div" cssClass="text-danger col-form-label ml-2" />
											</div>
										</div>
										<div class="form-group row">
											<form:label path="adtUccUrl" cssClass="col-sm-2 col-form-label">UCC_URL(매체가 UCC인 경우) </form:label>
											<div class="col-sm">
												<form:input path="adtUccUrl" cssClass="form-control col-sm-6" cssErrorClass="form-control col-sm-6 is-invalid"  />
												<form:errors path="adtUccUrl" element="div" cssClass="text-danger col-form-label ml-2" />
											</div>
										</div>
										<div class="form-group row">
											<form:label path="adtTvCf" cssClass="col-sm-2 col-form-label">자막 </form:label>
											<div class="col-sm">
										...
										<div class="form-group row">
											...
											<div class="col-sm">
												<div>
													...
													<span class="bg-light font-weight-bold text-info">- (파일크기 50 MB제한)</span>
												</div>
										...
										<c:if test="${archiveCategory.catSupportSelect1 }">
											<hr>
											<div class="form-group row">
												<label class="col-sm-2 col-form-label">TOP 추출 </label>
												<div class="col-sm">
													<div class="col-form-label">
														<div class="custom-control custom-checkbox custom-control-inline">
															<form:checkbox path="arcSelected1" class="custom-control-input" value="true"/>
															<label for="arcSelected11" class="custom-control-label"> TOP 추출</label>
														</div>
														<span class="bg-light font-weight-bold text-info">'대상'을 Top에 노출하기위한 추출입니다.</span>
													</div>
												</div>
											</div>
										</c:if>
