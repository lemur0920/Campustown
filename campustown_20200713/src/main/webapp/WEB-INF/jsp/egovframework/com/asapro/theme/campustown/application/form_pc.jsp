    ...
    <div class="area">
        <div class="table-con style2 mb30 applyTb">
            <table>
                ...
                <tr>
                    <th rowspan="4" scope="row" class="th-txl"><label>참가기업(팀)<br/>기본사항</label></th>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input name="setUpDate" class="input-80p datepicker-ui" placeholder="없을시 미기재" readonly>
                        <a href="#n"><img src="${design.resource}/images/sub/databox-icon.png" alt="달력" class="datepicker-img"></a>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input name="ownerBirth" class="input-80p datepicker-ui" readonly required>
                        <a href="#n"><img src="${design.resource}/images/sub/databox-icon.png" alt="달력" class="datepicker-img"></a>
                    </td>
    ...
    $(function() {
        $('#memAdd').click(function() {
            ...
            addRow = "<tr class=\"mem_tr\">\n" +
                ...
                "                    <td><input name=\"memBirth\" class=\"datepicker-ui input-60p\" readonly required><a href=\"#n\"><img src=\"${design.resource}/images/sub/databox-icon.png\" alt=\"달력\" class=\"datepicker-img\"></a></td>\n" +
