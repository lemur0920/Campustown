					        ...
					        <div class="card m-b-15">
					            <div class="card-body">
									...
									<div class="p-3 mb-3 bg-light text-info font-weight-bold">
										<div><i class="mdi mdi-information"></i> 교육 신청 </div>
									</div>
									
					            	<c:if test="${formMode eq 'INSERT'}"><c:set var="actionUrl" value="${ADMIN_PATH}/education/reservation/insert.do" /></c:if>
									<c:if test="${formMode eq 'UPDATE'}"><c:set var="actionUrl" value="${ADMIN_PATH}/education/reservation/update.do" /></c:if>
						            <form:form modelAttribute="educationReservationForm" cssClass="" action="${actionUrl}" method="post" enctype="multipart/form-data">
										...
										<div class="form-group row">
											<form:label path="reservDate" cssClass="col-sm-2 col-form-label">교육날짜 <span class="text-danger">*</span></form:label>
											<div class="col-sm form-inline">
										...
										<div class="form-group row">
											<form:label path="reservStime" cssClass="col-sm-2 col-form-label">교육희망시간 <span class="text-danger">*</span></form:label>
											<div class="col-sm form-inline">
										...
										<div class="form-group">
											...
											<a href="${ADMIN_PATH}/education/reservation/list.do" class="btn btn-secondary waves-effect m-l-5">목록</a>
										</div>
									</form:form>
					            </div>
					        </div>
