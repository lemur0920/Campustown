...
jQuery(function($){
    ...
    $('#deleteBtn').on('click', function () {
        ...
        swal({
        	...
        	$.ajax({
				url : '${ADMIN_PATH}/volunteer/reservation/delete.do'
				, type : 'post'
				, dataType: 'json'
				, data: {
					reservIds : reservIds
					...
					<div class="row">
					    <div class="col-sm-12">
					        <div class="card m-b-15">
					            <div class="card-body">
						            <form:form modelAttribute="volunteerReservationSearch" cssClass="" action="${ADMIN_PATH}/volunteer/reservation/list.do" method="get">
										...
										<div class="form-row mt-2 form-inline" >
											<label for="sc" class="mr-sm-3 mb-2">봉사일</label>
										...
										<div class="form-row mt-2 form-inline" >
											...
											<form:select path="sc" cssClass="form-control mr-sm-2 mb-2" title="검색조건">
												...
												<form:option value="RESERV_NAME" label="신청자명" />
												<form:option value="RESERV_GROUP" label="신청자 그룹" />
												<form:option value="RESERV_PURPOSE" label="목적" />
											</form:select>	
							...
							<div class="card m-b-30">
								<div class="card-body">
									...
									<div class="table-responsive">
										<table class="table table-striped table-hover ">
											<colgroup>
												...
												<col style="width: 12%;" /><!-- 신청자명 -->
												<col style="width: 40%;" /><!-- 신청자 그룹 -->
												<col style="width: 20%;" /><!-- 자원봉사 일시 -->
											...
											<tbody>
												...
												<c:forEach items="${paging.result}" var="item" varStatus="vs">
													<tr>
														...
														<td><a href="${ADMIN_PATH}/volunteer/reservation/update.do?reservId=${item.reservId}" class=""><strong>${item.reservName}</strong></a></td>
														<td><a href="${ADMIN_PATH}/volunteer/reservation/update.do?reservId=${item.reservId}" class=""><strong>${item.reservGroup}</strong></a></td>
									...
									<div class="form-inline">
										<div class="mr-auto">
											<a href="${ADMIN_PATH}/volunteer/reservation/insert.do" class="btn btn-primary waves-effect waves-light">추가</a>
