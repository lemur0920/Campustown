...
<c:import url="${design.themeDir}/layout/sidebar.jsp" charEncoding="UTF-8" />
	...
	<!-- content -->
	<div class="sub03-bluebox">
		<h5><strong>자유톡</strong>에서 창업자끼리 자유롭게 이야기를 나눠보세요!</h5>
		<p>자유톡은 서울 캠퍼스타운에 입주한 창업자들을 위한 <br>커뮤니티 공간입니다. 자유롭게 하고 싶은 이야기를 나눠보세요.<a class="go-next new-btn" href="${APP_PATH}/board/${boardConfig.bcId}/new">질문하기</a></p>
	</div>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td class="databox">
							<span>
								<form:input path="startDate" class="datepicker-ui" title="시작일을 입력하세요 예시)2020-01-01" placeholder="2020-01-01" autocomplete="off"/>
								<a href="#n"><img src="${design.resource}/images/sub/databox-icon.png" alt="달력" id="datepicker-img1" ></a>
							</span>
							&nbsp;~&nbsp;
							<span>
								<form:input path="endDate" class="datepicker-ui" title="종료일을 선택하세요 예시)2020-01-01" placeholder="2020-01-01" autocomplete="off"/>
	...
	<div class="board-table mtp50">
		<table>
			...
			<colgroup>
				...
				<col style="width: 15%" class="mb-none"><!-- 등록일 -->
