...
jQuery(function($){
    ...
    $('#deleteBtn').on('click', function () {
        ...
        swal({
        	...
        	$.ajax({
				url : '${ADMIN_PATH}/education/reservation/delete.do'
				, type : 'post'
				, dataType: 'json'
				, data: {
					reservIds : reservIds
					...
					<div class="row">
					    <div class="col-sm-12">
					        <div class="card m-b-15">
					            <div class="card-body">
						            <form:form modelAttribute="educationReservationSearch" cssClass="" action="${ADMIN_PATH}/education/reservation/list.do" method="get">
										...
										<div class="form-row mt-2 form-inline" >
											<label for="sc" class="mr-sm-3 mb-2">교육일</label>
							...
							<div class="card m-b-30">
								<div class="card-body">
											...
											<tbody>
												...
												<c:forEach items="${paging.result}" var="item" varStatus="vs">
													<tr>
														...
														<td><a href="${ADMIN_PATH}/education/reservation/update.do?reservId=${item.reservId}" class=""><strong>${item.reservGroup}</strong></a></td>
									...
									<div class="form-inline">
										<div class="mr-auto">
											<a href="${ADMIN_PATH}/education/reservation/insert.do" class="btn btn-primary waves-effect waves-light">추가</a>
