$(document).ready(function(){
	...
	*/
	...
	$("body").on('click', ".popup-content .popup-header > .close, .btn-area > .close", function(){
		$('.popup-box').hide();
		$(".popup-content").hide();
...
*/		
	...
	$(".owl-m2.owl-carousel").owlCarousel({
		...
		nav:true,
		touchDrag:false,
		mouseDrag:true,/*클릭시 탭안에 텍스트 선택되는 영향*/
		autoplay:false,
		autoplayTimeout:3000,
		autoplayHoverPause:true,
		responsiveClass:true,
	...
	/*창업활동랭킹 탭 시작*/
	$(".board-btnS1 li a").bind("click", function(e){ 
		$(".board-btnS1 li a").removeClass("on");
		$(this).addClass("on"); 
