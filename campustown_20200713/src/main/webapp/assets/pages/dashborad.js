...
jQuery(function($){
	...
	!function ($) {
		...
		Dashboard.prototype.init = function () {
			...
			this.createAreaChart('morris-area-chart', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#0097a7', '#ffbb44', '#f32f53']);
			...
			this.createBarChart('morris-bar-chart', $barData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#4c84ff','#6fd088', '#f75285']);
			...
			this.createDonutChart('morris-donut-chart', $donutData, ['#4c84ff', "#ebeff2", '#6fd088', '#f75285']);
