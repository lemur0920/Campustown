...
public class HttpHeaderSecurityFilter extends FilterBase {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(HttpHeaderSecurityFilter.class);
    ...
    public void setAntiClickJackingOption(String antiClickJackingOption) {
        ...
        throw new IllegalArgumentException("httpHeaderSecurityFilter.clickjack.invalid - " + antiClickJackingOption);
    }
