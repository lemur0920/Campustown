...
public class AsaproNetworkState {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AsaproNetworkState.class);
	/**
	 * <pre>
	...
	public static String getMyMACAddress(String localIP) {
		...
		try {
			if ("WINDOWS".equals(Globals.OS_TYPE)) {
				...
				in.close();
				out = new String(out.getBytes("iso-8859-1"), "euc-kr");
//				System.out.println(out );
				
//				String word = "인코딩 문제인가? 이클립스 문제인가? WAS문제 인가 그것이 알고 싶다....";
//				System.out.println("utf-8 -> euc-kr        : " + new String(out.getBytes("utf-8"), "euc-kr"));
//				System.out.println("utf-8 -> ksc5601       : " + new String(out.getBytes("utf-8"), "ksc5601"));
//				System.out.println("utf-8 -> x-windows-949 : " + new String(out.getBytes("utf-8"), "x-windows-949"));
//				System.out.println("utf-8 -> iso-8859-1    : " + new String(out.getBytes("utf-8"), "iso-8859-1"));
//				System.out.println("iso-8859-1 -> euc-kr        : " + new String(out.getBytes("iso-8859-1"), "euc-kr"));
//				System.out.println("iso-8859-1 -> ksc5601       : " + new String(out.getBytes("iso-8859-1"), "ksc5601"));
//				System.out.println("iso-8859-1 -> x-windows-949 : " + new String(out.getBytes("iso-8859-1"), "x-windows-949"));
//				System.out.println("iso-8859-1 -> utf-8         : " + new String(out.getBytes("iso-8859-1"), "utf-8"));
//				System.out.println("euc-kr -> utf-8         : " + new String(out.getBytes("euc-kr"), "utf-8"));
//				System.out.println("euc-kr -> ksc5601       : " + new String(out.getBytes("euc-kr"), "ksc5601"));
//				System.out.println("euc-kr -> x-windows-949 : " + new String(out.getBytes("euc-kr"), "x-windows-949"));
//				System.out.println("euc-kr -> iso-8859-1    : " + new String(out.getBytes("euc-kr"), "iso-8859-1"));
//				System.out.println("ksc5601 -> euc-kr        : " + new String(out.getBytes("ksc5601"), "euc-kr"));
//				System.out.println("ksc5601 -> utf-8         : " + new String(out.getBytes("ksc5601"), "utf-8"));
//				System.out.println("ksc5601 -> x-windows-949 : " + new String(out.getBytes("ksc5601"), "x-windows-949"));
//				System.out.println("ksc5601 -> iso-8859-1    : " + new String(out.getBytes("ksc5601"), "iso-8859-1"));
//				System.out.println("x-windows-949 -> euc-kr     : " + new String(out.getBytes("x-windows-949"), "euc-kr"));
//				System.out.println("x-windows-949 -> utf-8      : " + new String(out.getBytes("x-windows-949"), "utf-8"));
//				System.out.println("x-windows-949 -> ksc5601    : " + new String(out.getBytes("x-windows-949"), "ksc5601"));
//				System.out.println("x-windows-949 -> iso-8859-1 : " + new String(out.getBytes("x-windows-949"), "iso-8859-1"));
...
//				mac = out.substring(out.indexOf("MAC Address = ") + 14, out.indexOf("MAC Address = ") + 31);
				...
				if (out == null || out.indexOf("MAC 주소 = ") == -1) {
					throw new IllegalArgumentException("String Split Error!");
				}
				mac = out.substring(out.indexOf("MAC 주소 = ") + 9, out.indexOf("MAC 주소 = ") + 26);
