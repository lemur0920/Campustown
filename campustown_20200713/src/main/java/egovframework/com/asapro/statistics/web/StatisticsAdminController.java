...
public class StatisticsAdminController {
	 ...
	 * @return
	 */
	@RequestMapping(value=Constant.SITE_ID_PATH + Constant.ADMIN_PATH + "/statistics/admin/accessLog/list.do", method=RequestMethod.GET)
	public String statisticsAdminAccessLogListGet(Model model, @CurrentSite Site currentSite, @ModelAttribute("statisticsAdminAccessLogSearch") StatisticsAdminAccessLogSearch statisticsAdminAccessLogSearch){
		statisticsAdminAccessLogSearch.setSitePrefix(currentSite.getSitePrefix());
		List<StatisticsAdminAccessLog> list = statisticsService.getStatisticsAdminAccessLogList(statisticsAdminAccessLogSearch);
		int total = statisticsService.getStatisticsAdminAccessLogListTotal(statisticsAdminAccessLogSearch);
		
		Paging paging = new Paging(list, total, statisticsAdminAccessLogSearch);
		model.addAttribute("paging", paging);

		return "asapro/admin/statistics/adminAccessLogList";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value=Constant.SITE_ID_PATH + Constant.ADMIN_PATH + "/statistics/admin/inquireLog/list.do", method=RequestMethod.GET)
	public String statisticsAdminInquireLogListGet(Model model, @CurrentSite Site currentSite, @ModelAttribute("statisticsMemberInquireLogSearch") StatisticsMemberInquireLogSearch statisticsMemberInquireLogSearch){
		statisticsMemberInquireLogSearch.setSitePrefix(currentSite.getSitePrefix());
		List<StatisticsMemberInquireLog> list = statisticsService.getStatisticsAdminInquireLogList(statisticsMemberInquireLogSearch);
		int total = statisticsService.getStatisticsAdminInquireLogListTotal(statisticsMemberInquireLogSearch);
		
		Paging paging = new Paging(list, total, statisticsMemberInquireLogSearch);
		model.addAttribute("paging", paging);

		return "asapro/admin/statistics/adminInquireLogList";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value=Constant.SITE_ID_PATH + Constant.ADMIN_PATH + "/statistics/user/inquireLog/list.do", method=RequestMethod.GET)
	public String statisticsUserInquireLogListGet(Model model, @CurrentSite Site currentSite, @ModelAttribute("statisticsMemberInquireLogSearch") StatisticsMemberInquireLogSearch statisticsMemberInquireLogSearch){
		statisticsMemberInquireLogSearch.setSitePrefix(currentSite.getSitePrefix());
		List<StatisticsMemberInquireLog> list = statisticsService.getStatisticsUserInquireLogList(statisticsMemberInquireLogSearch);
		int total = statisticsService.getStatisticsUserInquireLogListTotal(statisticsMemberInquireLogSearch);
		
		Paging paging = new Paging(list, total, statisticsMemberInquireLogSearch);
		model.addAttribute("paging", paging);
		
		return "asapro/admin/statistics/userInquireLogList";
	}
