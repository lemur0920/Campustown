...
public class EgovSysInfo {
	...
	*/
	 ...
	 * @throws Exception 
	 */
	public static List<String> getDiskAttribute() throws Exception {
...
//		}
	 ...
	 * @throws Exception 
	 */
	public static List<String> getDiskCapacity() throws Exception {
...
//		}
	 ...
	 * @throws Exception 
	 */
	public static List<String> getExistDisk(String diskName) throws Exception {
...
//		}
	...
	*/
	 ...
	 * @see
	 */
	public static List<String[]> getProcessId() throws Exception {
		...
		try {
			...
			LOGGER.error("[IOException] Try/Catch... : "+ err.getMessage());
		}
	 ...
	 * @see
	 */
	public static List<String[]> getProcessId(String processName) throws Exception {
